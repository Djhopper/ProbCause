...
def main():
	with bayeslite.bayesdb_open(pathname=db_handle) as bdb:
		...
		ignore = ['CaseNumber','Date','Block','IUCR','PrimaryType','Description','LocationDescription','FBICode', 'UpdatedOn','XCoordinate', 'YCoordinate', 'Latitude', 'Longitude', 'Location']
